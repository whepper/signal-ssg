...
Signal 1.1 is stable. The current release is **1.1.0**: this minor release
adds the opt-in asset and image publishing pipeline while preserving 1.x
site configuration and CLI compatibility.
